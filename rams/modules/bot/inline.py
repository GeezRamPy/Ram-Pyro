...
async def ping_function(message: Message, answers):
    ...
    answers.append(
        InlineQueryResultArticle(
            ...
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="⇕ support ⇕", url="t.me/GeezRam")], [InlineKeyboardButton(text="◇ close ◇", callback_data="closed"), InlineKeyboardButton(text="❈ menu inline ❈", callback_data="reopen")]]
            ),
        )
    )
    return answers
